...
const SalesReportScreen = ({ route, navigation }: any) => {
  ...
  const [tableData, setTableData] = useState([
    { productCode: 'P001', customerCode: 'C1234', quantity: '2,500', amount: '€12,500' },
    { productCode: 'P002', customerCode: 'C5678', quantity: '1,800', amount: '€9,000' },
  ]);
        ...
        <View style={styles.content}>
          ...
          <View style={styles.formContainer}>
            ...
            <View style={styles.formRow}>
              <View style={styles.formGroup}>
                <Text style={styles.formLabel}>Sales Date *</Text>
          ...
          <View style={styles.tableContainer}>
            ...
            <View style={styles.tableHeader}>
              ...
              <Text style={[styles.tableHeaderCell, { flex: 1 }]}>Customer Code</Text>
            ...
            {tableData.map((item, index) => (
              <View key={index} style={[styles.tableRow, index % 2 === 0 ? styles.tableRowEven : styles.tableRowOdd]}>
                ...
                <Text style={[styles.tableCell, { flex: 1 }]}>{item.customerCode}</Text>
